...
const Links = () => {
  ...
  return (
    <article className="absolute bottom-[5rem] right-2 bg-[#292929a9] px-4 py-2 rounded-md flex items-center gap-4 max-sm:hidden max-lg:hidden max-xl:hidden lg:hidden shadow-md">
