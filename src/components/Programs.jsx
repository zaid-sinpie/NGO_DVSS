...
const Programs = () => {
  return (
    <section className=' max-xl:h-auto w-screen flex flex-col items-center max-sm:mx-0 max-sm:px-2 justify-start max-sm:justify-start gap-[2rem]'>
        ...
        <div className='flex flex-wrap max-sm:flex-col item-center justify-around gap-2 w-[80%] max-sm:w-auto'>
            {
